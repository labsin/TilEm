...
char* select_file(TilemCalcEmulator *emu, const char* basedir) {
	...
	dialog = gtk_file_chooser_dialog_new ("Open File", GTK_WINDOW(emu->ewin->window), GTK_FILE_CHOOSER_ACTION_OPEN, GTK_STOCK_CANCEL, GTK_RESPONSE_CANCEL, GTK_STOCK_OPEN, GTK_RESPONSE_ACCEPT, NULL);
...
char* select_dir(TilemCalcEmulator *emu, const char* basedir) {
	...
	dialog = gtk_file_chooser_dialog_new ("Open File", GTK_WINDOW(emu->ewin->window), GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER, GTK_STOCK_CANCEL, GTK_RESPONSE_CANCEL, GTK_STOCK_OPEN, GTK_RESPONSE_ACCEPT, NULL);
	pFileChooser=GTK_FILE_CHOOSER(dialog);
...
char* select_file_for_save(TilemCalcEmulator *emu, char* basedir) {
	...
	dialog = gtk_file_chooser_dialog_new ("Save File", GTK_WINDOW(emu->ewin->window), GTK_FILE_CHOOSER_ACTION_SAVE, GTK_STOCK_CANCEL, GTK_RESPONSE_CANCEL, GTK_STOCK_SAVE, GTK_RESPONSE_ACCEPT, NULL);
	pFileChooser=GTK_FILE_CHOOSER(dialog);
